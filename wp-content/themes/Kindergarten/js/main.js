window.onload = function () {
    ...
    for (const item of document.querySelectorAll('.img-btn-open')) {
...
function initializeClock(id, endtime) {
    ...
    function updateClock() {
        ...
        if (t.total <= 0) {
            document.querySelector('.timer_inner').classList.add('timer-none')
...
$('#inline-popups-yac').magnificPopup({
  delegate: 'a',
...
$('#inline-popups-leg').magnificPopup({
  delegate: 'a',
  removalDelay: 500, //delay removal by X to allow out-animation
  fixedContentPos: false,
  callbacks: {
...
$('#inline-popups-leg-2').magnificPopup({
  delegate: 'a',
  removalDelay: 500, //delay removal by X to allow out-animation
  fixedContentPos: false,
  callbacks: {
...
$('.form-popup-teams').magnificPopup({
	type: 'inline',
...
var swiper = new Swiper(".Swipers", {
	navigation: {
		nextEl: ".swiper-button-next-its",
		prevEl: ".swiper-button-prev-its",
	},
});
$(function(){
